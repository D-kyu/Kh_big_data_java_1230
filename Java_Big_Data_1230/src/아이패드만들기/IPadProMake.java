...
public class IPadProMake {
    ...
    private String serialNum; // 제품 일렬 번호 : iPad13123C2301121
    private static int cnt = 0; // 클래스 변수 : 객체 시 생성되지 않고 클래스 생성 시 만들어 짐
   ...
   public void setNetwork() {
    ...
    // 일력 번호 만들기 : iPda + 11/13 + 128/256/512/1204 + W/C = 230112 + 생산댓수}
    ...
    public void productPad() {
        ...
        System.out.println("일렬번호(S/N) : " + serialNum);
        System.out.println("---------------------------------");
    }
