...
public class MemberInfo { // 필드와 메소드가 있음
    ...
    // 주어진 조전에 맞는 직업을 입력 받아서 jobs 필드에 저장
    public void setJob(){
        while (true) {
            System.out.print("직업을 입력 하세요(1.학생, 2.회상원, 3.주부, 4.무직) : ");
            jobs = sc.nextInt();
    ...
    public void viewInfo() {
        String[] gengerStr = {"", "남성", "여성"};
        String[] jodsStr = {"", "학생", "회사원", "주부", "무직"};
        System.out.println("==== 회원 정보 출력 =====");
        System.out.println("이름 : " + name);
        System.out.println("나이 : " + age);
        System.out.println("성별 : " + gengerStr[getGenderType()]);
        System.out.println("직업 : " + jodsStr[jobs]);
    }
}
